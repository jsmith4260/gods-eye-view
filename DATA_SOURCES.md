...
| **Open-Meteo** | Current conditions and seven-day forecast in Views & Feeds, plus cockpit weather | [CC BY 4.0 data licence and adjacent-link attribution requirement](https://open-meteo.com/en/licence) | Linked "Weather data by Open-Meteo.com" beside the displayed local data |
| **NOAA NWS / SPC** | Active US alerts and explicitly dated preliminary storm reports | [NWS API documentation](https://www.weather.gov/documentation/services-web-api), [SPC reports](https://www.spc.noaa.gov/climo/reports/) | "NOAA National Weather Service / Storm Prediction Center" |
| **OpenWaters** | Keyless regional AIS vessel snapshots | [Public service](https://openwaters.io/); data remains subject to provider terms, no blanket redistribution licence asserted | "OpenWaters — regional AIS snapshots" plus original source when supplied |
| **MBTA, CapMetro, Metro Transit, HSL, OVapi, Entur, TransLink SEQ** | Seven regional public-transit vehicle-position feeds | Each operator's terms; exact feed, terms and attribution links in `src/data/transitFeeds.js` | Active operator credits registered in Data attribution |
